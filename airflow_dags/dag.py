...
with DAG(dag_id='process_reviews_and_metadata',
    ...
    common = {
        ...
        'image':
        '489198589229.dkr.ecr.eu-north-1.amazonaws.com/takeaway-challenge:live',
    ...
    process_metadata = KubernetesPodOperator(
        **common,
        ...
        arguments=[
            'python', 'src/entrypoint.py',
            '--task', 'process_raw_metadata_with_timestamps',
            '--start_timestamp', '{{ data_interval_start }}',
            '--end_timestamp', '{{ data_interval_end }}'
        ],
